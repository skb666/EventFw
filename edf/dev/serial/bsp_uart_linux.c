...
static drv_uart_data_t drv_data[Serial_Max] = {
    // Serial_Debug 调试串口
    {
        Serial_Rs232_1, &serial_232_1, DEV_SERIAL_WIFI, "/dev/ttyUSB0", DevType_Normal,
...
void bsp_uart_init(void)
{
    ...
    for (int i = 0; i < Serial_Max; i ++) {
        ...
        drv_data[i].serial_fd = INT32_MIN;
        // 串口设备注册
